...
class MoMoGateway(PaymentGateway):
    def __init__(self):
        ...
        self.base_url = getattr(
            settings, "MOMO_API_URL", "https://sandbox.momodeveloper.mtn.com"
        )
        ...
        try:
            response = requests.post(
                ...
                json={
                    ...
                    "payer": {
                        "partyIdType": "MSISDN",
                        "partyId": customer_phone.replace("+", ""),
                    },
    ...
    def verify_payment(self, reference: str, external_reference: str) -> PaymentResult:
        try:
            ...
            return PaymentResult(
                success=False, reference=reference, error_message="Payment failed"
            )
        except Exception as e:
            return PaymentResult(
                success=False, reference=reference, error_message=str(e)
    ...
    def process_refund(
        ...
        return RefundResult(
            ...
            error_message="MoMo refunds not supported via API",
        )
