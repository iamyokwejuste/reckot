...
class PayPalGateway(PaymentGateway):
    ...
    def initiate_payment(
        ...
        if not token:
            return PaymentResult(
                success=False, reference=reference, error_message="PayPal auth failed"
            )
        ...
        try:
            ...
            return PaymentResult(
                success=False, reference=reference, error_message=response.text
            )
        except Exception as e:
            return PaymentResult(
                success=False, reference=reference, error_message=str(e)
            )
    ...
    def verify_payment(self, reference: str, external_reference: str) -> PaymentResult:
        ...
        try:
            ...
            return PaymentResult(
                success=False, reference=reference, error_message="Capture failed"
            )
        except Exception as e:
            return PaymentResult(
                success=False, reference=reference, error_message=str(e)
    ...
    def process_refund(
        ...
        if not token:
            return RefundResult(
                ...
                error_message="PayPal auth failed",
            )
        ...
        try:
            ...
            return RefundResult(
                success=False, reference=payment_reference, error_message=response.text
            )
        except Exception as e:
            return RefundResult(
                success=False, reference=payment_reference, error_message=str(e)
            )
