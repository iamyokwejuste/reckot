...
class AffiliateLinkAdmin(admin.ModelAdmin):
    list_display = ['name', 'code', 'organization', 'event', 'commission_type', 'commission_value', 'clicks', 'is_active']
...
class AffiliateConversionAdmin(admin.ModelAdmin):
    list_display = ['affiliate_link', 'booking', 'order_amount', 'commission_amount', 'status', 'created_at']
