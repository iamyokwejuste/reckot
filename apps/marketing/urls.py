...
urlpatterns = [
    ...
    path('affiliates/<slug:org_slug>/', actions.AffiliateListView.as_view(), name='affiliate_list'),
    path('affiliates/<slug:org_slug>/create/', actions.AffiliateCreateView.as_view(), name='affiliate_create'),
    path('affiliates/<slug:org_slug>/<str:link_code>/', actions.AffiliateDetailView.as_view(), name='affiliate_detail'),
]
