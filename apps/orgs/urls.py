...
urlpatterns = [
    ...
    path('<slug:slug>/members/bulk-invite/', actions.BulkInviteView.as_view(), name='bulk_invite'),
    path('invite-template/', actions.DownloadInviteTemplateView.as_view(), name='invite_template'),
