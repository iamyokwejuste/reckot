...
urlpatterns = [
    ...
    path(
        "<slug:slug>/members/",
        actions.OrganizationMembersView.as_view(),
        name="members",
    ),
    path(
        "<slug:slug>/members/invite/",
        actions.InviteMemberView.as_view(),
        name="invite_member",
    ),
    path(
    ...
    path(
        ...
        actions.UpdateMemberRoleView.as_view(),
        name="update_member_role",
    ),
    path(
        "<slug:slug>/members/<int:user_id>/remove/",
        actions.RemoveMemberView.as_view(),
        name="remove_member",
    ),
    path("<slug:slug>/leave/", actions.LeaveOrganizationView.as_view(), name="leave"),
    path(
        "<slug:slug>/invitations/<int:invitation_id>/cancel/",
        actions.CancelInvitationView.as_view(),
        name="cancel_invitation",
    ),
    path(
        "<slug:slug>/invitations/<int:invitation_id>/resend/",
        actions.ResendInvitationView.as_view(),
