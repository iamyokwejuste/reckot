...
urlpatterns = [
    ...
    path('api/ai/generate-description/', ai.generate_description, name='ai_generate_description'),
    path('api/ai/improve-description/', ai.improve_description, name='ai_improve_description'),
    path('api/ai/generate-seo/', ai.generate_seo, name='ai_generate_seo'),
    path('api/ai/generate-caption/', ai.generate_social_caption, name='ai_generate_caption'),
